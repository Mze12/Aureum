  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a style="margin-left:10vh" href="../sistemaventas/register.php" class="page-scroll"><i style="font-size:18px;" class='bx bxs-user-circle'></i>Registro</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
...
>Aureum</h1>
            <h1 style="font-family: 'Black Ops One', system-ui;"
 >Inc</h1>
            <p>Reservaciones: +54 11 2315-3859</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="row">
      <div class="col-md-6">
        <div class="col-md-10 col-md-offset-1">
          ...
          <p>El chef comenzó su formación en el mundo gastronómico a los 15 años en las cocinas del Liceo Hotelero de Francia. Su trayectoria profesional le ha llevado a trabajar en algunos de los fogones más importantes de Francia: el Restaurante La Divellec, el Hotel Rosalp o el famoso restaurante de la Torre Eiffel, Jules Verne..</p>
          <p>En Argentina el chef ha capitaneado las cocinas de Aureum, en el que ha permanecido desde 2023 en el cual ha trasmitido sus conocimientos adquiridos desde su experiencia y carrera profesional.</p>
        </div>
      </div>
      <div class="col-md-6">
...
<div id="footer">
  <div class="container text-center">
    <div class="col-md-6">
      <p>&copy; 2024 Aureum - Todos los derechos reservados.</p>
    </div>
    <div class="col-md-6">
